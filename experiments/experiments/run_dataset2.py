...
Note: This dataset is much larger (~150k training samples), so
SVM training may take significant time.
"""
...
def run_experiments():
    """Run all classifiers on Dataset 2."""
    print("=" * 60)
    print("Running experiments on Dataset 2")
    print("=" * 60)
